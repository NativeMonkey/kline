...
public class SizeColor {
    ...
    private int markerBorderColor = Color.parseColor("#99000000"); // MarkerView 边框颜色0xff282b34
    private float markerTextSize = 21; // MarkerView 字符大小
    private int markerTextColor = Color.WHITE; // MarkerView 字符颜色0xff282b34
    ...
    private int increasingColor = Color.parseColor("#03C087"); // 上涨颜色0xffe05959
    private int decreasingColor = Color.parseColor("#E76D42"); // 下跌颜色0xff4fb86a
