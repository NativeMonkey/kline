...
public class TimeLineRender extends AbstractRender {
    ...
    public TimeLineRender(Context context) {
        this.context = context;
        kLineDrawingList.add(kLineGridAxisDrawing);
        kLineDrawingList.add(timeLineDrawing);
...
//        kLineDrawingList.add(emptyDataDrawing);
    ...
    public void onViewRect(RectF viewRect) {
        final float candleBottom = viewRect.bottom;
        ...
        for (StockIndex stockIndex : stockIndexList) {
            if (stockIndex.isEnable()) {
                ...
                float top = kLineRect.bottom  + calculateHeight - stockIndex.getHeight();
                float bottom = kLineRect.bottom  + calculateHeight;
